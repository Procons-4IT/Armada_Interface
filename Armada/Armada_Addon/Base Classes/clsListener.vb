        ...
        Try
            If pVal.BeforeAction = False Then
                Select Case pVal.MenuUID
                    ...
                    Case "Menu_B06"
                        'oMenuObject = New clsDiscountMgt
                        'oMenuObject.MenuEvent(pVal, BubbleEvent)
        ...
        Try
            ...
            If pVal.BeforeAction = False And pVal.EventType = SAPbouiCOM.BoEventTypes.et_FORM_LOAD Then
                Select Case pVal.FormTypeEx
                    ...
                    'Case frm_BarCode
                    '    If Not _Collection.ContainsKey(FormUID) Then
                    '        oItemObject = New clsBarCodeGeneration
                    '        oItemObject.FrmUID = FormUID
                    '        _Collection.Add(FormUID, oItemObject)
                    '    End If
                    'Case "frm_PrintBarCode"
                    '    If Not _Collection.ContainsKey(FormUID) Then
                    '        oItemObject = New clsBarCodePrinting
                    '        oItemObject.FrmUID = FormUID
                    '        _Collection.Add(FormUID, oItemObject)
                    '    End If

                    Case frm_ChoosefromList_Gen
                        If Not _Collection.ContainsKey(FormUID) Then
                            oItemObject = New clsChooseFromList_Gen
                            oItemObject.FrmUID = FormUID
                            _Collection.Add(FormUID, oItemObject)
                        End If
                    ...
                    Case frm_CompMap
                        If Not _Collection.ContainsKey(FormUID) Then
                            'oItemObject = New clsCompMapping
                            'oItemObject.FrmUID = FormUID
                            '_Collection.Add(FormUID, oItemObject)
                        End If
