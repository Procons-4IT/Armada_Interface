...
Public Class clsUtilities
    ...
    Public Sub ActivateMenuEvent(ByVal oApplication As SAPbouiCOM.Application, ByRef pVal As SAPbouiCOM.MenuEvent, ByVal UDOName As String)
        Try
    ...
    '            oDRow.Item("Quantity") = oTemp.Fields.Item("Quantity").Value
    ...
    '    Try
    '        strSQL = "SELECT ifnull(MAX(Cast(CAST(subString(""BcdCode"",0,13) AS Varchar) as Numeric)),0) FROM OBCD"
