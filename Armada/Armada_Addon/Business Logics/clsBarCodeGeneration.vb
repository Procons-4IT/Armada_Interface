Public Class clsBarCodeGeneration
    ...
    Public Sub LoadForm()
        Try
            ...
            otest.DoQuery("Select ifnull(""U_SEASON"",'') ,Count(*) from OITM group by ifnull(""U_SEASON"",'')")
            ...
            otest.DoQuery("Select ifnull(""U_BRAND"",'') ,Count(*) from OITM group by ifnull(""U_BRAND"",'')")
